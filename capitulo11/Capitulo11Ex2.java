...
public class Capitulo11Ex2 extends Applet implements KeyListener {
	...
	public static void main(String[] args) {
		Frame frame = new MainFrame(new Capitulo11Ex2(), 500, 500);
		frame.setTitle("Capítulo 11 Exercício 2 - Billboard");
	...
	private BranchGroup createSceneGraph() {
		...
		// código relacionado com o behavior Billboard
		Transform3D tr = new Transform3D();
		tr.setScale(0.1);
		tr.setTranslation(new Vector3f(0.7f, 0.25f, -0.1f));
		tr.setRotation(new AxisAngle4d(1d, 0d, 0d, (float) Math.toRadians(90)));
		TransformGroup tg = new TransformGroup(tr);
		root.addChild(tg);
		TransformGroup tgBillboard = new TransformGroup();
		tgBillboard.setCapability(TransformGroup.ALLOW_TRANSFORM_WRITE);
		tg.addChild(tgBillboard);
		Billboard bb = new Billboard(tgBillboard, Billboard.ROTATE_ABOUT_AXIS, new Point3f(0f, 0f, 0f));
		bb.setSchedulingBounds(bounds);
		tg.addChild(bb);

		String file = "texturas/vela.png";
		Shape3D imgPanel = createImagePanel(file);
		tgBillboard.addChild(imgPanel);
	...
	private Shape3D createImagePanel(String file) {
		...
		panel.setCoordinate(0, new Point3f(-1.0f, -1.0f, 0.0f));
		panel.setCoordinate(1, new Point3f(1.0f, -1.0f, 0.0f));
		panel.setCoordinate(2, new Point3f(1.0f, 1.0f, 0.0f));
		panel.setCoordinate(3, new Point3f(-1.0f, 1.0f, 0.0f));
		panel.setTextureCoordinate(0, 0, new TexCoord2f(0.0f, 0.0f));
		panel.setTextureCoordinate(0, 1, new TexCoord2f(1.0f, 0.0f));
		panel.setTextureCoordinate(0, 2, new TexCoord2f(1.0f, 1.0f));
		panel.setTextureCoordinate(0, 3, new TexCoord2f(0.0f, 1.0f));

		return new Shape3D(panel, ap);
	}
}

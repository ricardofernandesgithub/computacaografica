...
public class Candeeiro extends Group {
	public Candeeiro(Appearance ap, Material material1, Material material2) {
		...
		Shape3D shape = new Shape3D(abatJour);
		shape.setAppearance(ap);
		ap.setMaterial(material1);
		...
		ap = new Appearance();
		lampada.setAppearance(ap);
		ap.setMaterial(material2);
